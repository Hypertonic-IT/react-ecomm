                             ...
                             {orders.map(order => (
                                 <div key={order._id} style={{ background: '#fff', padding: '20px', borderRadius: '12px', border: '1px solid #eee', display: 'flex', flexDirection: 'column', gap: '15px' }}>
                                     <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid #f0f0f0', paddingBottom: '10px' }}>
                                         <div>
                                             <span style={{ fontWeight: 'bold', color: '#333', display: 'block', marginBottom: '4px' }}>
                                                 Order ID: <code style={{ background: '#f1f5f9', padding: '2px 6px', borderRadius: '4px', fontSize: '12px', fontFamily: 'monospace' }}>{order._id}</code>
                                             </span>
                                     ...
                                     <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '5px', borderTop: '1px solid #f9fafb', paddingTop: '10px' }}>
                                         <div style={{ display: 'flex', gap: '20px' }}>
                                             <div style={{ fontSize: '13px', color: '#555' }}>
                                                 <FaClock style={{ marginRight: '5px', verticalAlign: 'middle' }} />
                                                 Status: <strong style={{ textTransform: 'uppercase', color: order.status === 'Delivered' ? '#10b981' : '#f59e0b' }}>{order.status || (order.isDelivered ? 'Delivered' : 'Pending')}</strong>
                                             </div>
                                             <div style={{ fontSize: '13px', color: '#555' }}>
